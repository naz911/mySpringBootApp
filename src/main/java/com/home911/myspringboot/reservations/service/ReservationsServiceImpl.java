...
public class ReservationsServiceImpl implements ReservationsService {
	...
	public String createReservation(ReservationBean reservationBean) {
		...
		try {
			...
			return reservation.getReservationUuid();
		} catch (DataIntegrityViolationException e) {
			throw new ReservationConflictException("Unable to obtain reservation lock, the requested reservation dates might already be taken. (fromDate=" + reservationBean.getFromDate() + ", toDate=" + reservationBean.getToDate() + ")");
		}
	}
